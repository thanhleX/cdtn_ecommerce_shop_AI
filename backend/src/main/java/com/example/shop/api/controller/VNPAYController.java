...
import com.example.shop.application.dto.request.PaymentRequest;
import com.example.shop.infrastructure.config.VNPayConfig;
...
public class VNPAYController {
    ...
    public ResponseEntity<?> healthCheck() {
        return ResponseEntity.ok(Map.of("status", "UP", "message", "VNPay Module inside Backend is running"));
    }
}
